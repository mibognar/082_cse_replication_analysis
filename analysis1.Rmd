...
## Loading data
```{r}
hun_data = read_csv("data/hun_data.txt")
it_data = read_csv("data/it_data_fixed.txt")
...
easystats::bayesfactor_models(no_interaction_model, interaction_model)
